            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8 relative z-10">
                ...
                <div className="overflow-hidden">
                    <motion.div
                        ...
                        animate={{ x: [0, -400 * 2] }} // Estimate width of items * count
                        transition={{
                            repeat: Infinity,
                            duration: 15,
                            ease: "linear",
                    ...
                    >
                        {/* Duplicate Key items to create infinite effect */}
                        {[1, 2, 1, 2, 1, 2].map((id, index) => (
                            <div key={index} className="flex-none w-[85vw] sm:w-[500px]">
                                {id === 1 ? (
                                    /* Course 1 */
                                    <Link
                                        href="/courses/free-course-1"
                                        className="group relative bg-white/60 dark:bg-black/20 backdrop-blur-xl rounded-3xl shadow-lg border border-gray-100 dark:border-gray-800 overflow-hidden hover:shadow-xl hover:shadow-[#D4Af37]/20 hover:-translate-y-1 transition-all duration-300 flex flex-col h-full"
                                    >
                                        {/* Image Section */}
                                    ...
                                    <Link
                                        ...
                                        className="group relative bg-white/60 dark:bg-black/20 backdrop-blur-xl rounded-3xl shadow-lg border border-gray-100 dark:border-gray-800 overflow-hidden hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col h-full"
                                    >
                                        {/* Image Section */}
                                        <div className="relative h-64 w-full overflow-hidden">
                                            <Image
