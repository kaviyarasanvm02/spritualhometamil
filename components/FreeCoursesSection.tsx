...
export default function FreeCoursesSection() {
    ...
    return (
        <section id="free-courses" className="bg-gray-50 dark:bg-gray-900 py-24 sm:py-32 relative overflow-hidden transition-colors duration-300">
            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8 relative z-10">
                <div className="text-center max-w-2xl mx-auto mb-16">
                    ...
                    <p className="text-lg text-gray-600 dark:text-gray-300">
                        {t.freeCourses.subtitle || "Begin your transformation with our complimentary spiritual guides."}
                    </p>
                </div>
                        ...
                        <div key={index} className="flex flex-col h-full">
                            {id === 1 ? (
                                ...
                                <Link
                                    ...
                                    className="group relative bg-white/60 dark:bg-black/20 backdrop-blur-xl rounded-2xl md:rounded-3xl shadow-lg border border-gray-100 dark:border-gray-800 overflow-hidden hover:shadow-xl hover:shadow-[#D4Af37]/20 hover:-translate-y-1 transition-all duration-300 flex flex-col h-full"
                                >
                                    {/* Image Section */}
                                    ...
                                    <div className="p-6 sm:p-8 flex flex-col flex-1">
                                        <div className="flex-1">
                                            ...
                                            <h3 className="text-xl sm:text-2xl font-serif font-bold text-gray-900 dark:text-white mb-3 sm:mb-4 leading-tight group-hover:text-[#996515] dark:group-hover:text-[#F3C623] transition-colors">
                                        ...
                                        <div className="mt-auto">
                                            <div className="w-full flex items-center justify-center gap-2 bg-brand-gradient text-white px-6 py-3 sm:py-4 rounded-xl font-bold shadow-lg shadow-[#D4Af37]/20 group-hover:shadow-[#D4Af37]/40 transition-all duration-300 text-sm sm:text-base">
                                ...
                                <Link
                                    ...
                                    className="group relative bg-white/60 dark:bg-black/20 backdrop-blur-xl rounded-2xl md:rounded-3xl shadow-lg border border-gray-100 dark:border-gray-800 overflow-hidden hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col h-full"
                                >
                                    {/* Image Section */}
                                    <div className="relative h-56 sm:h-64 w-full overflow-hidden">
                                        <Image
                                    ...
                                    <div className="p-6 sm:p-8 flex flex-col flex-1">
                                        <div className="flex-1">
                                            ...
                                            <h3 className="text-xl sm:text-2xl font-serif font-bold text-gray-900 dark:text-white mb-3 sm:mb-4 leading-tight group-hover:text-purple-700 dark:group-hover:text-purple-400 transition-colors">
                                        ...
                                        <div className="mt-auto">
                                            <div className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-purple-500 to-purple-600 text-white px-6 py-3 sm:py-4 rounded-xl font-bold shadow-lg shadow-purple-500/20 group-hover:shadow-purple-500/40 transition-all duration-300 text-sm sm:text-base">
                                                <ArrowRight className="h-4 w-4" />
