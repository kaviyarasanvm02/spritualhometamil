            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8 relative z-10">
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="text-center lg:text-left">
                        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-amber-500/10 border border-amber-500/20 text-amber-400 text-sm font-medium mb-6 animate-fade-in">
                            <Sparkles className="w-4 h-4" />
                            <span>{t.freeResources.title}</span>
                        </div>

                        <h2 className="text-3xl font-extrabold tracking-tight text-white sm:text-5xl mb-6 leading-tight drop-shadow-xl">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                            <button className="group flex items-center justify-center gap-3 bg-gradient-to-r from-amber-500 to-amber-600 text-white px-8 py-4 rounded-xl font-bold shadow-lg shadow-amber-500/20 hover:shadow-amber-500/40 hover:scale-[1.02] transition-all duration-300">
                                <Download className="h-5 w-5 group-hover:animate-bounce" />
                                <span>{t.freeResources.downloadTamil}</span>
                            </button>
                            <button className="group flex items-center justify-center gap-3 bg-white/10 text-white px-8 py-4 rounded-xl font-bold border border-white/10 hover:bg-white/20 hover:border-white/30 backdrop-blur-sm transition-all duration-300">
                    ...
                    <div className="relative mx-auto w-full max-w-md lg:max-w-none">
                        <div className="relative aspect-[4/5] sm:aspect-[3/4] lg:aspect-square max-h-[500px] w-full bg-gradient-to-br from-gray-800 to-gray-900 rounded-3xl border border-white/10 shadow-2xl overflow-hidden group hover:border-amber-500/50 transition-colors duration-500">
